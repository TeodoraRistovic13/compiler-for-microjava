...
public class FormCommaParamDecl extends FormalParamList {

    private FormalParamList FormalParamList;
    private FormalParamDecl FormalParamDecl;

    public FormCommaParamDecl (FormalParamList FormalParamList, FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormCommaParamDecl(\n");
